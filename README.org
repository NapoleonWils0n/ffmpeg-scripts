...
#+BEGIN_SRC sh
extract-frame -i infile.(mp4|mov|mkv|m4v|webm) -s 00:00:00 -o outfile.mp4
#+END_SRC
...
#+BEGIN_SRC sh
tile-thumbnails -i infile.(mp4|mkv|mov|m4v|webm) -s 00:00:00 -w 000 -t 0x0 -p 00 -m 00 -c color -o outfile.png
#+END_SRC
